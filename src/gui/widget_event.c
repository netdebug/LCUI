...
static void DestroyWidgetEventPack( void *arg )
{
	...
	_DEBUG_MSG( "pack: %p, widget: %p\n", pack, pack->event.target );
			    ...
			    void *data, void( *destroy_data )(void*) )
{
	...
	_DEBUG_MSG( "add record, pack: %p, widget: %p\n", pack, widget );
	/* 把任务扔给当前跑主循环的线程 */
